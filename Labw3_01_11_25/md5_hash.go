...
func lab1() {
	...
	fmt.Println("=======================================================")
	fmt.Println("🔐 🧪  Lab 1: Hashing (MD5) — Password Cracker  🧪 🔐")
	fmt.Println("=======================================================")

	wordlistPath := "nord_vpn.txt"
	targetHash := "6a85dfd77d9cb35770c9dc6728d73d3f"
	verboseFile := "results/verbose1.txt"
	...
	for scanner.Scan() {
		...
		h := crack.MD5Hash(password)

		// Verbose line: timestamp, attempt number, password, md5
